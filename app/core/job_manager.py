...
class JobManager:
    ...
    async def create_job(self, placa: str = None, renavam: str = None, cpf: str = None, chassi: str = None, query_type: str = "orcamento") -> str:
        ...
        # Only send columns we actually have a value for, so an optional field
        # (e.g. chassi) never depends on the column existing in the table.
