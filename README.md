...
Uma API de alto desempenho para consultas veiculares automatizadas e consolidadas (DETRAN-RJ, SEFAZ-RJ e Bradesco). Construída com FastAPI, Playwright (Scraping) e Supabase (Banco de Dados e Fila).

---

## 📋 Funcionalidades
- **Consultas Independentes**: Cadastro (Detran), IPVA (Sefaz), Débitos GRT/Multas (Bradesco).
